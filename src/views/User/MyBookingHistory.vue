...
const q = ref("");
const bookings = ref([
  { id: 101, service: "City Tour", date: "2026-03-02", status: "COMPLETED" },
  { id: 102, service: "Temple Tour", date: "2026-03-10", status: "UPCOMING" },
  { id: 103, service: "Beach Trip", date: "2026-03-14", status: "PENDING" },
]);
...
const filtered = computed(() => {
  ...
  return bookings.value.filter((b) =>
    `${b.id} ${b.service} ${b.date} ${b.status}`.toLowerCase().includes(s),
  );
});
</script>
